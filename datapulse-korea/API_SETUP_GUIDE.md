...
**용도**: 호우, 대설, 강풍, 풍랑, 태풍, 건조, 한파, 폭염 등 **12개 기상현상**에 대한 **실시간 특보 발표**

**특징**:
- ✅ **실시간 발표**: 위험 상황 발생 시 즉시 특보 발표
- ✅ **최신 업데이트**: 2024년 7월 19일 수정
- ✅ **세부 지역**: 171개 시·군 단위로 주의보/경보 구분
- ✅ **활용도 높음**: 활용신청 4,604건 (인기 API)

**신청** (2가지 방법):
1. **공공데이터포털** (권장): https://www.data.go.kr/data/15000415/openapi.do
   - 회원가입 후 "활용신청" 버튼 클릭
   - 즉시 승인 또는 1~2일 소요

2. **기상자료개방포털**: https://data.kma.go.kr/
   - 회원가입 후 "데이터 > 기상예보 > 기상특보"에서 인증키 발급

**엔드포인트**:
- 특보목록조회: `http://apis.data.go.kr/1360000/WthrWrnInfoService/getWthrWrnList`
- 특보통보문조회: `http://apis.data.go.kr/1360000/WthrWrnInfoService/getWthrWrnMsg`
...
- `pageNo`: 1
- `dataType`: JSON
- `areaCode`: 지역코드 (선택) (예: 11 = 서울)

**특보 종류**:
- 호우주의보/경보, 대설주의보/경보, 강풍주의보/경보
- 풍랑주의보/경보, 태풍주의보, 건조주의보
- 한파주의보/경보, 폭염주의보/경보 등
    ...
    "body": {
      "items": {
        "item": [{
          ...
          "warnVar": "호우경보",
          "warnStress": "경보",
          "tmFc": "2025-10-31 14:00",
          "warnMsg": "서울·인천·경기도에 호우경보가 발표되었습니다..."
        }]
      }
    }
  }

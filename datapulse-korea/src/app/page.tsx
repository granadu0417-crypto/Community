    ...
    <main className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="max-w-2xl mx-auto mb-16 animate-slide-up">
            <div className="relative">
              ...
              />
              <button className="absolute right-2 top-1/2 -translate-y-1/2 px-6 py-2 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition">
                검색
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto mb-20">
            {[
              ...
              <div
                key={idx}
                className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition animate-fade-in"
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={idx}
                className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 hover:shadow-2xl transition duration-300 border border-gray-100"
              >
                <div className={`text-6xl mb-4 bg-gradient-to-r ${feature.color} bg-clip-text`}>
                  {feature.icon}
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {[
              ...
              <button
                key={idx}
                className={`${theme.color} rounded-xl p-6 hover:scale-105 transition duration-300 shadow-md hover:shadow-xl`}
              >
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <button className="px-8 py-4 bg-white text-blue-600 rounded-xl font-bold text-lg hover:shadow-2xl transition transform hover:scale-105">
            내 동네 점수 확인하기
          </button>
        </div>
      </section>
